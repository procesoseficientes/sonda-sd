        ...
        if (buttonIndex === 2) {
            ...
            if (gIsOnline == EstaEnLinea.Si) {
                ...
                var data = {
                    ...
                    loginid: gLastLogin,
                    lastinvoice: parseInt(localStorage.getItem("POS_CURRENT_INVOICE_ID")) + 1,
                    dbuser: gdbuser,
                                                ...
                                                ObtenerDetallePorConsignacion(
                                                    ...
                                                    function(detalleConsignacion) {
                                                        if (detalleConsignacion.length > 0) {
                                                            ...
                                                            for (
                                                                var i = 0; i < detalleConsignacion.length; i++
                                                            ) {
                ...
                tx.executeSql(
                    ...
                    function(tx, results) {
                        if (results.rows.length > 0) {
                            ...
                            errCallback({
                                code: -1,
                                message: "4-Error al obtener las cuentas de bancos: No hay cuentas de bancos configuradas"
                            });
                        }
                    },
                    function(tx, err) {
                        errCallback({
                            code: -1,
                            message: "3-Error al obtener las cuentas de bancos: " + err.message
                        });
                    }
                );
            },
        ...
        obtenerCuentasDeBancos(
            function(cuentaDeBanco) {
                ...
                for (var i = 0; i < cuentaDeBanco.length; i++) {
                    var item = {
                        text: cuentaDeBanco[i].banco + " - " + cuentaDeBanco[i].numeroDeCuenta,
