var DocumentoVentaControlador = (function () {
    ...
    DocumentoVentaControlador.prototype.delegarDocumentoControlador = function () {
        ...
        $("#pos_skus_page").on("click", "#pos_skus_page_listview li", function (event) {
            var esCombo = event.currentTarget.attributes["esCombo"].nodeValue;
            if (esCombo === '1') {
                _this.limpiarListaDeSku(function () {
                ...
                case OpcionRespuesta.Exito:
                    ...
                    switch (data.source) {
                        case OpcionValidarSaldoCliente.FinalizarDocumento:
                            ...
                            _this.finalizarOrdenDeVenta();
                            _this.limpiarComentario();
                            break;
                    }
                    break;
        ...
        switch ($.mobile.activePage[0].id) {
            case "pos_skus_page":
                this.validarFecha(function () {
                    if (_this.permiterRegregarPantallaAnterior) {
    ...
    DocumentoVentaControlador.prototype.obtenerFechaFormato = function (fecha, agregarDia) {
        ...
        var resultado = anio + "/" + (mes[1] ? mes : "0" + mes[0]) + "/" + (dia[1] ? dia : "0" + dia[0]);
        return resultado;
    };
        ...
        try {
            if (this.cliente.totalAmout <= 0) {
                ...
                this.validarConfiguracionDeBonificacionPorCombos(function () {
                    ...
                    _this.cliente.salesComment = uiComentarioDeOrdenDeVenta.val();
                            ...
                            if (listaDeReglasAplicarReglasComerciales.length > 0 &&
                                ...
                                _this.tareaServicio.obtenerRegla("ValidarConServidorAntiguedadDeSaldos", function (listaDeReglasValidarConServidorAntiguedadDeSaldos) {
                                    if (gIsOnline === EstaEnLinea.No ||
                                        ...
                                        var listaSku = [];
                                        _this.clienteServicio.validarCuentaCorriente(_this.cliente, listaSku, _this.tarea.salesOrderType, _this.configuracionDecimales, function (cliente) {
                                        ...
                                        _this.clienteServicio.enviarSolicitudParaObtenerCuentaCorriente(_this.socketIo, _this
                                            .cliente, OpcionValidarSaldoCliente.FinalizarDocumento, _this.tarea.salesOrderType, function (cliente) {
                                        }, function (resultado) {
                                            notify(resultado.mensaje);
                                            my_dialog("", "", "closed");
                                        });
        ...
        try {
            navigator.notification.confirm("Desea finalizar el documento?", function (buttonIndex) {
                if (buttonIndex === 2) {
                    ...
                    _this.cliente.deliveryDate = uiFechaEntrega.val();
                    uiFechaEntrega = null;
                    _this.mostarResumenDeOrdenDeVenta();
                }
        ...
        EstaGpsDesavilitado(function () {
            ...
            _this.limpiarListaDeSku(function () {
                if (_this.descuentoPorMontoGeneral.apply) {
                    var promo = new Promo();
                    promo.promoId = _this.descuentoPorMontoGeneral.promoId;
                    promo.promoName = _this.descuentoPorMontoGeneral.promoName;
                    promo.promoType = _this.descuentoPorMontoGeneral.promoType;
                    promo.frequency = _this.descuentoPorMontoGeneral.frequency;
                    _this.listaDeSkuOrdenDeVenta[0].listPromo.push(promo);
                    promo = null;
                }
                $.mobile.changePage("SalesOrderSummaryPage", {
                    ...
                    data: {
                        ...
                        "listaSku": _this.listaDeSkuOrdenDeVenta,
                        "listaDeSkuParaBonificacion": _this.listaDeSkuParaBonificacion,
                        "listaDeSkuParaBonificacionDeCombo": _this.listaDeSkuParaBonificacionDeCombo,
                        "usuarioPuedeModificarBonificacionDeCombo": _this.usuarioPuedeModificarBonificacionDeCombo,
                        "listaDeBonificacionesPorMontoGeneral": _this.listaDeBonificacionesPorMontoGeneral,
                        "listaDeDescuentoPorMontoGeneralYFamilia": _this.listaDeDescuentoPorMontoGeneralYFamilia,
                        "listaDeDescuentoPorFamiliaYTipoPago": _this.listaDeDescuentoPorFamiliaYTipoPago
                    }
                });
            }, function (resultado) {
                notify(resultado.mensaje);
    ...
    DocumentoVentaControlador.prototype.obtenerSku = function (idSku, packUnit) {
        ...
        try {
            ...
            listarSku_1.map(function (lSku) {
                _this.tarea.salesOrderTotal = _this.obtenerTotalParaEnviar(_this.listaDeSkuOrdenDeVenta, lSku);
                _this.obtenerBonificacionPorUnidad(lSku, listaDeSkuParaBonificacion_1);
            });
            this.limpiarListaDeSku(function () {
                $.mobile.changePage("skucant_page", {
                    ...
                    data: {
                        ...
                        "listaDeSkuOrdenDeVenta": _this.listaDeSkuOrdenDeVenta
                    }
                });
            }, function (resultado) {
                notify(resultado.mensaje);
    ...
    DocumentoVentaControlador.prototype.eliminarSku = function (idSku, packUnit, callback, errCallback) {
        try {
            ...
            errCallback({ codigo: -1, mensaje: "Error al eliminar sku: " + err.mensaje });
        }
    };
    ...
    DocumentoVentaControlador.prototype.usuarioDeseaEliminarSku = function (idSku, packUnit) {
        ...
        try {
            navigator.notification.confirm("Confirma remover de la lista al SKU " + idSku + "?", function (buttonIndex) {
                if (buttonIndex === 2) {
                    _this.eliminarSku(idSku, packUnit, function () {
                        _this.obtenerBonificacionesPorComboEnListado(function () {
    ...
    DocumentoVentaControlador.prototype.publicarDatos = function () {
        ...
        try {
            ...
            this.listaDeSkuOrdenDeVenta.map(function (sku) {
                if (_this.cliente.skus === "") {
                    _this.cliente.skus += "'" + sku.sku + "'";
                }
                else {
                    _this.cliente.skus += ",'" + sku.sku + "'";
                }
    ...
    DocumentoVentaControlador.prototype.cargarListaSku = function () {
        ...
        try {
            ...
            this.obtenerDescuentosPorMontoYFamiliaYTipoPago(function () {
                _this.cargarBonificacionesPorMontoGeneral(function () {
                    if (_this.listaDeSkuOrdenDeVenta.length > 0) {
                        for (var j = 0; j < _this.listaDeSkuParaBonificacionDeCombo.length; j++) {
                            if (_this.listaDeSkuParaBonificacionDeCombo[j].skusDeBonoPorCombo.length > 0) {
                                var liPorCombo = "<li LineSeq='" + j.toString() + "' esCombo='1' id='" + _this.listaDeSkuParaBonificacionDeCombo[j].comboId + "' data-filtertext='" + _this.listaDeSkuParaBonificacionDeCombo[j].comboId + " " + _this.listaDeSkuParaBonificacionDeCombo[j].nameCombo + "' style='padding:5px; background-color:#1a8dff'>";
                                liPorCombo += "<a class='ui-alt-icon ui-shadow ui-nodisc-icon' href='#' id=''>";
                                liPorCombo += "<h4>" + _this.listaDeSkuParaBonificacionDeCombo[j].nameCombo + " - " + (_this.listaDeSkuParaBonificacionDeCombo[j].bonusSubType === SubTipoDeBonificacionPorCombo.Unica.toString() ? DescripcionSubTipoDeBonificacionPorCombo.Unica.toString() : DescripcionSubTipoDeBonificacionPorCombo.Multiple.toString()) + "</h4>";
                                if (_this.listaDeSkuParaBonificacionDeCombo[j].isConfig) {
                                    if (_this.listaDeSkuParaBonificacionDeCombo[j].isEmpty) {
                                        liPorCombo += "<span class='small-roboto'>Se configuro el combo para que no bonifique</span><br/>";
                                    }
                                    else {
                                        for (var _i = 0, _a = _this.listaDeSkuParaBonificacionDeCombo[j].skusDeBonoPorComboAsociados; _i < _a.length; _i++) {
                                    ...
                                    if (_this.listaDeSkuParaBonificacionDeCombo[j].bonusSubType === SubTipoDeBonificacionPorCombo.Unica.toString() && _this.listaDeSkuParaBonificacionDeCombo[j].skusDeBonoPorCombo.length > 1) {
                                        liPorCombo += "<span class='small-roboto'>No se ha configurado la Bonificaci\u00F3n</span><br/>";
                                    }
                                    else {
                                        if (_this.usuarioPuedeModificarBonificacionDeCombo && usarMaximaBonificacion_1 === false) {
                                            liPorCombo += "<span class='small-roboto'>Se configuro el combo para que no bonifique</span><br/>";
                                        }
                                        else {
                                            for (var _b = 0, _c = _this.listaDeSkuParaBonificacionDeCombo[j].skusDeBonoPorCombo; _b < _c.length; _b++) {
                                                ...
                                                if (skuParaBonificacionDeCombo.selectedQty > skuParaBonificacionDeCombo.qty) {
                                                    ...
                                                    if (!_this.usuarioPuedeModificarBonificacionDeCombo || usarMaximaBonificacion_1) {
                                                        skuParaBonificacionDeCombo.selectedQty = skuParaBonificacionDeCombo.qty;
                                                    }
                                                }
                    ...
                    for (var i = 0; i < _this.listaDeSkuOrdenDeVenta.length; i++) {
                        ...
                        tabla += "<span id='SKU_QTY_" + sku.sku.replace(" ", "_") + "' class='small-roboto'>Cant.: " + format_number(sku.qty, _this.configuracionDecimales.defaultDisplayDecimals) + "  UM: " + sku.codePackUnit + "  Pre.: " + DarFormatoAlMonto(format_number(sku.cost, _this.configuracionDecimales.defaultDisplayDecimals)) + "</span><br/>";
                        tabla += "<span id='SKU_AVAIL_" + sku.sku.replace(" ", "_") + "' class='small-roboto'>Disponible: " + format_number(sku.available, _this.configuracionDecimales.defaultDisplayDecimals) + "</span><br/>";
                        if (sku.handleDimension) {
                            ...
                            for (var _d = 0, _e = sku.dimensions; _d < _e.length; _d++) {
                                var dimension = _e[_d];
                                var dimensionSku = trunc_number(dimension.dimensionSku, _this.configuracionDecimales.defaultCalculationsDecimals);
                                var cantidad = trunc_number(dimension.qtySku, _this.configuracionDecimales.defaultCalculationsDecimals);
                                var total_1 = trunc_number(parseFloat(dimension.total.toString()), _this.configuracionDecimales.defaultCalculationsDecimals);
                                tabla += "<tr>";
                                tabla += "<td style='width: 30%; text-align: left;'>";
                                tabla += "<span class='small-roboto'>" + format_number(cantidad, _this.configuracionDecimales.defaultDisplayDecimals) + "</span>";
                                tabla += "</td>";
                                tabla += "<td style='width: 30%;text-align: center;'>";
                                tabla += "<span class='small-roboto'>" + format_number(dimensionSku, _this.configuracionDecimales.defaultDisplayDecimals) + "</span>";
                                tabla += "</td>";
                                tabla += "<td style='width: 30%;text-align: right;'>";
                                tabla += "<span class='small-roboto'>" + format_number(total_1, _this.configuracionDecimales.defaultDisplayDecimals) + "</span>";
                                tabla += "</td>";
                                tabla += "</tr>";
                            }
                            tabla += "</table><br/>";
                        ...
                        if (sku.discount !== 0) {
                            switch (sku.discountType) {
                                case TiposDeDescuento.Porcentaje.toString():
                                    tabla += "<span id='SKU_DISCOUNT_" + sku.sku.replace(" ", "_") + "' class='small-roboto'> Des: " + format_number(sku.appliedDiscount, _this.configuracionDecimales.defaultDisplayDecimals) + "%</span>";
                                    break;
                                case TiposDeDescuento.Monetario.toString():
                                    tabla += "<span id='SKU_DISCOUNT_" + sku.sku.replace(" ", "_") + "' class='small-roboto'> Des: " + DarFormatoAlMonto(format_number(sku.appliedDiscount, _this.configuracionDecimales.defaultDisplayDecimals)) + "</span>";
                                    break;
                            }
                            if (!resultadoDescuentoPorMontoGeneralYFamilia && !resultadoDescuentoPorFamiliaYTipoPago) {
                                tabla += "<span id='SKU_LINE_TOTALCD_" + sku.sku.replace(" ", "_") + "' class='small-roboto'> Total: " + format_number(sku.total, _this.configuracionDecimales.defaultDisplayDecimals) + "</span>";
                            }
                        }
                        if (resultadoDescuentoPorMontoGeneralYFamilia) {
                            switch (resultadoDescuentoPorMontoGeneralYFamilia.discountType) {
                                case TiposDeDescuento.Porcentaje.toString():
                                    tabla += "<span id='SKU_DISCOUNT_MGF_" + sku.sku.replace(" ", "_") + "' class='small-roboto'> DMF: " + format_number(resultadoDescuentoPorMontoGeneralYFamilia.discount, _this.configuracionDecimales.defaultDisplayDecimals) + "%</span>";
                                    break;
                                case TiposDeDescuento.Monetario.toString():
                                    tabla += "<span id='SKU_DISCOUNT_MGF_" + sku.sku.replace(" ", "_") + "' class='small-roboto'> DMF: " + DarFormatoAlMonto(format_number(resultadoDescuentoPorMontoGeneralYFamilia.discount, _this.configuracionDecimales.defaultDisplayDecimals)) + "</span>";
                                    break;
                            }
                        ...
                        if (resultadoDescuentoPorFamiliaYTipoPago) {
                            switch (resultadoDescuentoPorFamiliaYTipoPago.discountType) {
                                case TiposDeDescuento.Porcentaje.toString():
                                    tabla += "<span id='SKU_DISCOUNT_MGF_" + sku.sku.replace(" ", "_") + "' class='small-roboto'> DFT: " + format_number(resultadoDescuentoPorFamiliaYTipoPago.discount, _this.configuracionDecimales.defaultDisplayDecimals) + "%</span>";
                                    break;
                                case TiposDeDescuento.Monetario.toString():
                                    tabla += "<span id='SKU_DISCOUNT_MGF_" + sku.sku.replace(" ", "_") + "' class='small-roboto'> DFT: " + DarFormatoAlMonto(format_number(resultadoDescuentoPorFamiliaYTipoPago.discount, _this.configuracionDecimales.defaultDisplayDecimals)) + "</span>";
                                    break;
                            }
                            tabla += "<span id='SKU_LINE_TOTALCD_" + sku.sku.replace(" ", "_") + "' class='small-roboto'> Total: " + format_number(sku.total, _this.configuracionDecimales.defaultDisplayDecimals) + "</span>";
                        }
                        ...
                        if (sku.discount !== 0) {
                            switch (sku.discountType) {
                                case TiposDeDescuento.Porcentaje.toString():
                                    total = trunc_number((total - ((sku.appliedDiscount * total) / 100)), _this.configuracionDecimales.defaultCalculationsDecimals);
                                    break;
                                case TiposDeDescuento.Monetario.toString():
                                    total = trunc_number(total - sku.appliedDiscount, _this.configuracionDecimales.defaultCalculationsDecimals);
                                    break;
                            }
                        }
                        if (resultadoDescuentoPorMontoGeneralYFamilia) {
                            switch (resultadoDescuentoPorMontoGeneralYFamilia.discountType) {
                                case TiposDeDescuento.Porcentaje.toString():
                                    total = trunc_number((total - ((resultadoDescuentoPorMontoGeneralYFamilia.discount * total) / 100)), _this.configuracionDecimales.defaultCalculationsDecimals);
                                    break;
                                case TiposDeDescuento.Monetario.toString():
                                    total = trunc_number(total - resultadoDescuentoPorMontoGeneralYFamilia.discount, _this.configuracionDecimales.defaultCalculationsDecimals);
                                    break;
                            }
                        }
                        if (resultadoDescuentoPorFamiliaYTipoPago) {
                            switch (resultadoDescuentoPorFamiliaYTipoPago.discountType) {
                                case TiposDeDescuento.Porcentaje.toString():
                                    total = trunc_number((total - ((resultadoDescuentoPorFamiliaYTipoPago.discount * total) / 100)), _this.configuracionDecimales.defaultCalculationsDecimals);
                                    break;
                                case TiposDeDescuento.Monetario.toString():
                                    total = trunc_number(total - resultadoDescuentoPorFamiliaYTipoPago.discount, _this.configuracionDecimales.defaultCalculationsDecimals);
                                    break;
                            }
                        }
                        tabla += "<a href=\"#\" id=\"" + OpcionEnListadoDePedido.Modificar.toString() + "|" + sku.sku + "|" + sku.codePackUnit + "|detalle\" class='ui-btn ui-corner-all small-roboto' style=\"margin-top: 20px;\">" + DarFormatoAlMonto(format_number(total, _this.configuracionDecimales.defaultDisplayDecimals)) + "</a>";
                        tabla += '</td></tr>';
                        var listaDeSkuABonificar = new Array();
                        _this.obtenerBonificacionPorUnidad(sku, listaDeSkuABonificar);
        ...
        try {
            ...
            _this.tareaServicio.obtenerRegla("CalcularTotalDeImpuesto", function (listaDeReglas) {
                if (listaDeReglas.length > 0 && listaDeReglas[0].enabled.toUpperCase() === 'SI') {
                    ...
                    porcentajeDeImpuesto_1 = (porcentajeDeImpuesto_1 > 0 ? (porcentajeDeImpuesto_1 / 100) : 0.00);
                    totalOrden = (totalOriginalOrdenDeVenta * porcentajeDeImpuesto_1) + totalOriginalOrdenDeVenta;
    ...
    DocumentoVentaControlador.prototype.prepararOrdenDeVentaParaInsertar = function (callback) {
        ...
        try {
            this.obtenerSecuenciaDeDocumentos(this, function (sequence, serie, numeroDeDocumento, controlador) {
                ...
                switch (_this.configuracionDecimales.displayDecimalsRoundType) {
                    case "TRUNC":
                    ...
                    case "CEILING":
                        ...
                        break;
                    default:
                        ordenDeVenta.totalAmount = trunc_number(controlador.cliente.totalAmout, _this.configuracionDecimales.defaultCalculationsDecimals);
                        break;
                }
                ...
                ordenDeVenta.discount = trunc_number(controlador.cliente.appliedDiscount, _this.configuracionDecimales.defaultCalculationsDecimals);
                ordenDeVenta.discountApplied = trunc_number(controlador.cliente.discount, _this.configuracionDecimales.defaultCalculationsDecimals);
                ...
                controlador.listaDeSkuOrdenDeVenta.map(function (sku, index, array) {
                    ...
                    ordenDeVentaDetalle.qty = trunc_number(sku.qty, _this.configuracionDecimales.defaultCalculationsDecimals);
                    ordenDeVentaDetalle.price = trunc_number(sku.cost, _this.configuracionDecimales.defaultCalculationsDecimals);
                    switch (_this.configuracionDecimales.displayDecimalsRoundType) {
                        case "TRUNC":
                            ordenDeVentaDetalle.totalLine = trunc_number(sku.total, _this.configuracionDecimales.defaultCalculationsDecimals);
                            break;
                        case "ROUND":
    ...
    DocumentoVentaControlador.prototype.prepararOrdenDeVentaParaActualizar = function (callback) {
        ...
        try {
            ...
            this.listaDeSkuOrdenDeVenta.map(function (sku, index, array) {
                var ordenDeVentaDetalle = new OrdenDeVentaDetalle();
                ordenDeVentaDetalle.salesOrderId = _this.ordenDeVentaDraft.salesOrderId;
                ordenDeVentaDetalle.sku = sku.sku;
                ordenDeVentaDetalle.lineSeq = (index + 1);
                ordenDeVentaDetalle.qty = trunc_number(sku.qty, _this.configuracionDecimales.defaultCalculationsDecimals);
                ordenDeVentaDetalle.price = trunc_number(sku.cost, _this.configuracionDecimales.defaultCalculationsDecimals);
                ...
                ordenDeVentaDetalle.discount = 0;
                ordenDeVentaDetalle.codePackUnit = sku.codePackUnit;
                ordenDeVentaDetalle.docSerie = _this.ordenDeVentaDraft.docSerie;
                ordenDeVentaDetalle.docNum = _this.ordenDeVentaDraft.docNum;
                _this.ordenDeVentaDraft.ordenDeVentaDetalle.push(ordenDeVentaDetalle);
            });
        ...
        try {
            if (this.tarea.hasDraft) {
                navigator.notification.confirm("Desea cancelar la venta como borrador?", function (buttonIndex) {
                    if (buttonIndex === 2) {
                        _this.ordenDeVentaServicio.cancelarOCompletarOrdenDeVentaDraft(_this.ordenDeVentaDraft, function () {
                            _this.tarea.hasDraft = false;
                            _this.ordenDeVentaDraft = new OrdenDeVenta();
                            _this.ordenDeVentaDraft.ordenDeVentaDetalle = [];
                            EnviarData();
                        }, function (resultado) {
                            notify(resultado.mensaje);
                        });
                        ...
                        navigator.notification.confirm("Desea guardar la venta como borrador?", function (buttonIndex) {
                            if (buttonIndex === 2) {
                                if (_this.tarea.hasDraft) {
                                    _this.prepararOrdenDeVentaParaActualizar(function (ordenDeVenta) {
                                        _this.ordenDeVentaServicio.actualizarOrdenDeVentaDraft(ordenDeVenta, function () {
                                            $.mobile.changePage("#pickupplan_page", {
                                                transition: "flow",
                                                reverse: true,
                                                changeHash: false,
                                    ...
                                    _this.prepararOrdenDeVentaParaInsertar(function (ordenDeVenta) {
                                        _this.ordenDeVentaServicio.insertarOrdenDeVentaDraft(ordenDeVenta, function () {
                                            $.mobile.changePage("#pickupplan_page", {
                                                transition: "flow",
                                                reverse: true,
                                                changeHash: false,
    ...
    DocumentoVentaControlador.prototype.obtenerTotalDeOrdenDeVenta = function (descuentoDelCliente, listaDeSku) {
        var _this = this;
        var total = 0;
        listaDeSku.map(function (sku) {
            var totalSku = sku.total;
            switch (sku.discountType) {
                case TiposDeDescuento.Porcentaje.toString():
                    totalSku = (parseFloat(sku.discount.toString()) !== 0 ? (totalSku - ((parseFloat(sku.appliedDiscount.toString()) * totalSku) / 100)) : totalSku);
                    break;
                case TiposDeDescuento.Monetario.toString():
    ...
    DocumentoVentaControlador.prototype.obtenerTotalParaEnviar = function (listaDeSku, sku) {
        ...
        listaDeSku.map(function (skuParaTotal) {
            ...
            if (sku.codeFamilySku !== skuParaTotal.codeFamilySku) {
                var resultadoDescuentoPorMontoGeneralYFamilia = _this.listaDeDescuentoPorMontoGeneralYFamilia.find(function (descuentoABuscar) {
    ...
    DocumentoVentaControlador.prototype.obtenerBonificacionesPorComboEnListado = function (callback) {
        ...
        this.bonoServicio.obtenerBonificacionesPorCombo(this.cliente.bonoPorCombos, this.listaDeSkuOrdenDeVenta, function (bonificacionPorCombosEnListaDeSkus) {
            _this.listaDeSkuParaBonificacionDeCombo = bonificacionPorCombosEnListaDeSkus;
            callback();
        }, function (resultado) {
    ...
    DocumentoVentaControlador.prototype.validarConfiguracionDeBonificacionPorCombos = function (callback, errCallback) {
        try {
            ...
            this.listaDeSkuParaBonificacionDeCombo.map(function (bono) {
                if (estanConfiguradosLosCombos_1 && bono.bonusSubType === SubTipoDeBonificacionPorCombo.Unica.toString() && bono.isConfig === false && bono.skusDeBonoPorCombo.length > 1) {
                    estanConfiguradosLosCombos_1 = false;
                    errCallback({ codigo: -1, mensaje: "No se han configurado todos los combos" });
                }
            });
            ...
            errCallback({ codigo: -1, mensaje: "Error al validar combos del pedido: " + e.message });
        }
    };
    ...
    DocumentoVentaControlador.prototype.cargarBonificacionesPorMontoGeneral = function (callback, errCallback) {
        ...
        try {
            ...
            this.bonoServicio.obtenerBonificacionPorMontoGeneral(this.cliente, totalOriginalOrdenDeVenta, function (listaDeBonificacionesPorMontoGeneral) {
                _this.obtenerHistoricodePromo(function (listaHistoricoDePromos) {
                    _this.validarSiAplicaLaBonificacionesPorMontoGeneral(listaDeBonificacionesPorMontoGeneral, 0, listaHistoricoDePromos, function (listaDeBonificacionesParaAplicar) {
                        _this.listaDeBonificacionesPorMontoGeneral = new Array();
                        if (listaDeBonificacionesParaAplicar.length > 0) {
                            _this.listaDeBonificacionesPorMontoGeneral = listaDeBonificacionesParaAplicar;
                            var liParaAgregar_1 = new Array();
                            _this.listaDeBonificacionesPorMontoGeneral.map(function (bono) {
                ...
                if (this.listaDeBonificacionesTerminoDeIterar(listaDeBonificaciones, indiceDeListaDeBonificacion)) {
                    ...
                    if (resultadoDePromoHistorico_1) {
                        ...
                        this.promoServicio.validarSiAplicaPromo(promoDeBonificacion, resultadoDePromoHistorico_1, function (aplicaPromo) {
                            ...
                            _this.validarSiAplicaLaBonificacionesPorMontoGeneral(listaDeBonificaciones, indiceDeListaDeBonificacion + (aplicaPromo ? 1 : 0), listaHistoricoDePromos, function (listaDeBonificaciones) {
    ...
    DocumentoVentaControlador.prototype.validarSiAplicaElDescuentoPorMontoGeneralYFamilia = function (listaDeDescuento, indiceDeListaDeDescuento, listaHistoricoDePromos, callBack, errCallback) {
        var _this = this;
        try {
            if (listaHistoricoDePromos.length > 0) {
    ...
    DocumentoVentaControlador.prototype.listaDeDescuentoPorMontoGeneralYFamiliaTerminoDeIterar = function (listaDeDescuento, indiceDeListaDeDescuento) {
        return (listaDeDescuento.length > 0 && listaDeDescuento.length > indiceDeListaDeDescuento);
    };
    DocumentoVentaControlador.prototype.validarSiAplicaElDescuentoPorFamiliaYTipoPago = function (listaDeDescuento, indiceDeListaDeDescuento, listaHistoricoDePromos, callBack, errCallback) {
        var _this = this;
        try {
            if (listaHistoricoDePromos.length > 0) {
                if (this.listaDeDescuentoPorMontoFamiliaYTipoPagoTerminoDeIterar(listaDeDescuento, indiceDeListaDeDescuento)) {
                    ...
                    var resultadoDePromoHistorico_3 = listaHistoricoDePromos.find(function (promo) {
    ...
    DocumentoVentaControlador.prototype.listaDeDescuentoPorMontoFamiliaYTipoPagoTerminoDeIterar = function (listaDeDescuento, indiceDeListaDeDescuento) {
        return (listaDeDescuento.length > 0 && listaDeDescuento.length > indiceDeListaDeDescuento);
    };
