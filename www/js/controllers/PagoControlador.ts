class PagoControlador {
    ...
    constructor(public mensajero: Messenger) {
        ...
        this.tokenListaOrdenDeVenta = mensajero.subscribe<ListaSkuMensaje>(this.listaDeSkuDeVentaEntregado, getType(ListaSkuMensaje), this);
    ...
    usuarioDeseaVerPantallaAnterior() {
        let uiTextoNumeroDeDocumentoDeCheque = $("#UiTextoNumeroDeDocumentoDeCheque");
        let uiEtiquetaFormaDePagoSeleccionada = $("#UiEtiquetaFormaDePagoSeleccionada");
    ...
    usuarioSelecionoAceptarFormaDePago(_this: PagoControlador) {
        ...
        if (_this.tipoDePago === TipoDePago.Cheque && (uiTextoNumeroDeDocumentoDeCheque.val().trim() === '' || _this.imagen1 === null)) {
            ...
            if (_this.pago === null || _this.pago === undefined) {
                ...
                _this.pagoServicio.formarPagoUnicoDesdeLista(_this.cliente, _this.listaDeSkuDeVenta, _this.tipoDePago, numeroDeDocumento, _this.imagen1, _this.imagen2, (pago: PagoEncabezado) => {
                    _this.pago = pago;
