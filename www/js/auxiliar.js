        ...
        SONDA_DB_Session.transaction(
            function (tx) {
                try {
                    ...
                    tx.executeSql("CREATE TABLE IF NOT EXISTS HISTORY_BY_PROMO([DOC_SERIE], [DOC_NUM], [CODE_ROUTE], [CODE_CUSTOMER], [HISTORY_DATETIME], [PROMO_ID], [PROMO_NAME], [FREQUENCY], [IS_POSTED], [SERVER_POSTED_DATETIME], [DEVICE_NETWORK_TYPE], [IS_POSTED_OFFLINE], [SALES_ORDER_DOCUMENT_NUMBER], [SALES_ORDER_DOCUMENT_SERIES] )");

                    tx.executeSql("CREATE TABLE IF NOT EXISTS DISCOUNT_LIST_BY_GENERAL_AMOUNT_AND_FAMILY(DISCOUNT_LIST_ID, CODE_FAMILY, LOW_AMOUNT, HIGH_AMOUNT, DISCOUNT_TYPE, DISCOUNT, PROMO_ID, PROMO_NAME, PROMO_TYPE, FREQUENCY)");

                    tx.executeSql("CREATE TABLE IF NOT EXISTS DISCOUNT_LIST_BY_FAMILY_AND_PAYMENT_TYPE(DISCOUNT_LIST_ID, PAYMENT_TYPE, CODE_FAMILY, DISCOUNT_TYPE, DISCOUNT, PROMO_ID, PROMO_NAME, PROMO_TYPE, FREQUENCY)");
