      ...
      bluetoothSerial.isConnected(
        ...
        function() {
          bluetoothSerial.connectInsecure(
            ...
            function() {
              errorCallback(
                "No se ha podido establecer conexión con la impresora"
              );
            }
          );
        }
...
function ObtenerFormatoImpresionDevolucion(lskSku, callback, errCallback) {
  try {
    ...
    formatoEncabezado +=
      "! U1 LMARGIN 10\r\n! U\r\n! U1 PAGE-WIDTH 1400\r\nON-FEED IGNORE\r\n";
    formatoEncabezado +=
      "CENTER 550 T 1 2 0 10 " + CenterText(gCompanyName) + "\r\n";
    formatoEncabezado +=
      "CENTER 550 T 1 2 0 60 " + CenterText(gBranchName) + "\r\n";
    formatoEncabezado += "L 5 100 570 100  1\r\n";

    formatoEncabezado +=
      "LEFT 5 T 0 2 0  110 Vendedor: " +
      localStorage.getItem("POS_LAST_LOGIN_ID") +
      "\r\n";
    formatoEncabezado +=
      "LEFT 5 T 0 2 0  140 Ruta: " +
      localStorage.getItem("POS_CURRENT_ROUTE") +
      "\r\n";
    ...
    for (var i = 0; i < lskSku.length; i++) {
      ...
      formatoDetalle +=
        "LEFT 5 T 0 2 0 " + pRow + " CANTIDAD: " + sku.Quantity + "\r\n";
      pRow += parseInt(30);
    ...
    formato =
      ...
      " 1\r\n" +
      formatoEncabezado +
      "CENTER 550 T 0 2 0 180 *****ORIGINAL***** \r\n" +
      formatoDetalle;
...
function ObtenerFormatoDeImpresionRecollecionConsignacion(
  documento,
  callBack,
  errorCallBack
) {
  try {
    ...
    formato += "CENTER 575 \r\n";
    formato +=
      "T 7 0 0 " + posY + " CLIENTE: " + documento.CUSTOMER_ID + "\r\n";
    ...
    for (var i = 0; i < documento.DEVOLUTION_DETAIL.length; i++) {
      ...
      if (skuDetalle.SKU_NAME.length > 30) {
        formato +=
          ...
          posY +
          " " +
          skuDetalle.SKU_NAME.substring(0, 30) +
          "..." +
          "\r\n";
      } else {
      ...
      formato += "RIGHT 410\r\n";
      formato +=
        "T 0 2 410 " + posY + " " + skuDetalle.QTY_SKU.toString() + "\r\n";
      formato += "RIGHT 550\r\n";
      ...
      if (skuDetalle.HANDLE_SERIAL === 1 || skuDetalle.HANDLE_SERIAL === "1") {
        ...
        formato += "LEFT 5 \r\n";
        formato +=
          "T 7 0 5 " + posY + " Serie:" + skuDetalle.SERIAL_NUMBER + "\r\n";
      }
    ...
    errorCallBack(
      "Error al intentar obtener el formato de impresión para los productos recogidos debido a: " +
        e.message
    );
  }
}

function ObtenerFormatoDeImpresionDeReporteDeLiquidacionFinDeRuta(
  objetoReportes,
  callBack,
  errorCallBack
) {
  try {
    ...
    manejoDeDecimalesServicio.obtenerInformacionDeManejoDeDecimales(function(
      manejoDeDecimales
    ) {
      var formato = "";
      var rowPosition = 10;
      ...
      formato +=
        ...
        rowPosition +
        " " +
        (gCompanyName.length > 45 ? CenterText(gCompanyName) : gCompanyName) +
        "\r\n";
      ...
      formato +=
        ...
        rowPosition +
        " " +
        (gBranchName.length > 45 ? CenterText(gBranchName) : gBranchName) +
        "\r\n";
      ...
      if (gBranchAddress.length > 30) {
        ...
        if (
          localStorage.getItem("direccionFacturacion01") &&
          localStorage.getItem("direccionFacturacion01").length > 0
        ) {
          rowPosition += 45;
          formato +=
            "CENTER 550 T 0 2 0 " +
        ...
        if (
          localStorage.getItem("direccionFacturacion02") &&
          localStorage.getItem("direccionFacturacion02").length > 0
        ) {
          rowPosition += 20;
          formato +=
            "CENTER 550 T 0 2 0 " +
        ...
        if (
          localStorage.getItem("direccionFacturacion03") &&
          localStorage.getItem("direccionFacturacion03").length > 0
        ) {
          rowPosition += 20;
          formato +=
            "CENTER 550 T 0 2 0 " +
        ...
        if (
          localStorage.getItem("direccionFacturacion04") &&
          localStorage.getItem("direccionFacturacion04").length > 0
        ) {
          rowPosition += 20;
          formato +=
            "CENTER 550 T 0 2 0 " +
      ...
      rowPosition += 20;
      formato +=
        "CENTER 550 T 7 0 0 " + rowPosition + " REPORTE DE LIQUIDACIÓN \r\n";
      ...
      formato +=
        ...
        ". " +
        format_number(
          objetoReportes.TOTAL_A_LIQUIDAR,
      ...
      rowPosition += 20;
      formato +=
        "CENTER 550 T 7 0 0 " + rowPosition + " LIQUIDACIÓN INVENTARIO \r\n";

      rowPosition += 25;
      formato += "LEFT 5 \r\n";
      formato +=
        "T 7 0 5 " + rowPosition + " INV.INI = Inventario Inicial  \r\n";
      ...
      for (var i = 0; i < skusInventario.length; i++) {
        ...
        formato +=
          ...
          format_number(
            sku.QTY_SOLD,
            manejoDeDecimales.defaultDisplayDecimalsForSkuQty
          ) +
          "\r\n";
        formato += "LEFT 25 \r\n";
        formato +=
      ...
      //RESUMEN DE FACTURAS -------------------------------------------------------
      if (
        objetoReportes.VISUALIZAR_E_IMPRIMIR_RESUMEN_DE_FACTURAS &&
        ...
        rowPosition += 20;
        formato +=
          "CENTER 550 T 7 0 0 " + rowPosition + " LIQUIDACION DE FACTURAS \r\n";
        ...
        objetoReportes.FACTURAS_DE_RUTA.forEach(function(factura) {
          sumatoriaTotalDeFacturas +=
            factura.STATUS === 3 ? 0 : factura.TOTAL_AMOUNT;
      ...
      rowPosition += 155;
      formato +=
        "LEFT 5 L 0 " + rowPosition + " 250 " + rowPosition + " 1 \r\n";
      formato +=
        "RIGHT 550 L 500 " + rowPosition + " 700 " + rowPosition + " 1 \r\n";
      ...
      rowPosition += 20;
      formato +=
        "CENTER 550 T 0 2 0 " + rowPosition + " www.mobilityscm.com/sonda \r\n";
    ...
    console.log(
      "Error al intentar obtener el formato de impresion debido a: " + e.message
    );
    errorCallBack(e.message);
  }
}

function ObtenerFormatoDeImpresionDeReporteDeLiquidacionDeEntrega(
  objetoReportes,
  callBack,
  errorCallBack
) {
  try {
    ...
    manejoDeDecimalesServicio.obtenerInformacionDeManejoDeDecimales(function(
      ...
      var entregasNoCompletadas =
        objetoReportes.DEMANDAS_DE_DESPACHO_NO_ENTREGADAS_O_CANCELADAS;
      ...
      formato +=
        "CENTER 550 T 7 0 0 " +
        posY +
        " REPORTE DE LIQUIDACIÓN DE ENTREGAS \r\n";
      ...
      if (TieneEntregasCompletadas(entregasCompletadas)) {
        ...
        entregasCompletadas.map(function(entregaCompletada) {
          ...
          formato +=
            ...
            posY +
            " Entrega: " +
            entregaCompletada.DELIVERY_NOTE_ID +
            " \r\n";
          formato += "RIGHT 550\r\n";
          formato +=
            "T 7 0 550 " +
            posY +
            " Factura: " +
            entregaCompletada.INVOICE_ID +
            "/" +
            entregaCompletada.INVOICE_STATUS +
            "\r\n";
          ...
          formato +=
            ...
            posY +
            " Cliente: " +
            entregaCompletada.CODE_CUSTOMER +
            " \r\n";
          formato += "RIGHT 550\r\n";
          formato +=
            "T 7 0 550 " +
            ...
            format_number(
              trunc_number(
                entregaCompletada.TOTAL_AMOUNT,
          ...
          formato +=
            ...
            posY +
            " Nom. Cliente: " +
            entregaCompletada.cliente.RELATED_CLIENT_NAME +
            " \r\n";
      ...
      if (TieneEntregasCanceladas(entregasNoCompletadas)) {
        ...
        formato += "SETBOLD 1\r\n";
        formato +=
          "CENTER 550 T 7 0 0 " + posY + " ENTREGAS NO PROCESADAS \r\n";
        formato += "SETBOLD 0\r\n";
        ...
        entregasNoCompletadas.map(function(entregaCancelada) {
          ...
          formato += "LEFT 5 \r\n";
          formato +=
            "T 7 0 5 " + posY + " Orden: " + entregaCancelada.DOC_NUM + " \r\n";
          formato += "RIGHT 550\r\n";
          formato +=
            "T 7 0 550 " +
            posY +
            " Factura: " +
            entregaCancelada.ERP_REFERENCE_DOC_NUM +
            "\r\n";
      ...
      posY += 20;
      formato +=
        "CENTER 550 T 0 2 0 " + posY + " www.mobilityscm.com/sonda \r\n";
...
function ObtenerFormatoDeImpresionDePago(
  documentoDePago,
  callback,
  errorCallback
) {
  try {
    ...
    formato +=
      ...
      posicionDeLinea +
      " " +
      CenterText(documentoDePago.branchName) +
      "\r\n";
    ...
    var totalFacturas = 0;
    documentoDePago.overdueInvoicePaymentDetail.forEach(function(
      detalleDePago,
      numeroDeIteracion
    ) {
    ...
    if (documentoDePago.reprint) {
      posicionDeLinea += 30;
      formato +=
        "CENTER 550 T 7 0 0 " + posicionDeLinea + " *** RE-IMPRESO *** \r\n";
    }
